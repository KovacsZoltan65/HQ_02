...
class SubdomainSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $arr_subdomains = [
            ['id' => 1, 'subdomain' => 'showtime','url'    => 'http://showtime.ejelenlet/',    'name' => 'Showtime',                         'db_host' => 'localhost', 'db_port' => 3306, 'db_name' => 'ej2_showtime',      'db_user' => 'ej2_showtime',      'db_password' => 'bqNxN86xwatT68wv', 'notification' => 1, 'state_id' => 1, 'is_mirror' => 0 ,'sso' => 0, 'access_control_system' => 5, 'last_export' => '2023-01-01 00:00:00',],
